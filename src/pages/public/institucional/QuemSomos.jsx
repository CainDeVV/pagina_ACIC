...
function QuemSomos() {
  return (
    <SaibaMaisLayout titulo="Quem Somos">
      ...
      <h1 className="quem-somos-titulo">A CACB</h1>
      ...
      <section>
        <h2 className="quem-somos-subtitulo">Histórico</h2>
        <p>
        ...
        <p>
          O termo <em>comercial</em>, presente na nomenclatura destas associações vem de transação comercial,
