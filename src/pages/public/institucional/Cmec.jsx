...
function Cmec() {
  return (
    <SaibaMaisLayout titulo="CMEC">
      ...
      <h1 className="cmec-titulo">Conselho da Mulher Empreendedora e da Cultura</h1>

      <img 
        src="https://cacb.org.br/wp-content/uploads/2022/09/CMEC_NOVO-LOGO_Nacional-Padrao-2.png" 
        alt="Banner oficial do CMEC Nacional" 
      ...
      <section>
        <h2 id="titulo-conquistas" className="cmec-subtitulo">Nossas Conquistas</h2>
        <p>
      ...
      <div className="cmec-galeria">
        <img 
          ...
          alt="Reunião de lideranças femininas do CMEC" 
        />
        <img 
          src="https://cacb.org.br/wp-content/uploads/2023/10/Conselho-CMEC-outubro-2023-2.jpeg" 
          alt="Palestra sobre empreendedorismo feminino" 
        />
      </div>
