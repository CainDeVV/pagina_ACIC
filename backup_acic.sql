...
\restrict EJXdc9UxcPaaJiFk0kgaZr49S54WABx2Rt2Kx9fqu9D1tcTmp1zUcKWoBCgykpf
...
ALTER TABLE ONLY public."Servico" DROP CONSTRAINT "Servico_authorId_fkey";
ALTER TABLE ONLY public."Noticia" DROP CONSTRAINT "Noticia_authorId_fkey";
ALTER TABLE ONLY public."InscricaoEvento" DROP CONSTRAINT "InscricaoEvento_eventoId_fkey";
ALTER TABLE ONLY public."InscricaoEvento" DROP CONSTRAINT "InscricaoEvento_associadoId_fkey";
ALTER TABLE ONLY public."HomeSlide" DROP CONSTRAINT "HomeSlide_authorId_fkey";
ALTER TABLE ONLY public."Evento" DROP CONSTRAINT "Evento_authorId_fkey";
ALTER TABLE ONLY public."CertificadoSolicitacao" DROP CONSTRAINT "CertificadoSolicitacao_eventoId_fkey";
ALTER TABLE ONLY public."CertificadoSolicitacao" DROP CONSTRAINT "CertificadoSolicitacao_associadoId_fkey";
ALTER TABLE ONLY public."Associado" DROP CONSTRAINT "Associado_userId_fkey";
DROP INDEX public."User_email_key";
DROP INDEX public."Servico_slug_key";
DROP INDEX public."QuemSomosSection_key_key";
DROP INDEX public."Noticia_slug_key";
DROP INDEX public."InscricaoEvento_eventoId_associadoId_key";
DROP INDEX public."Evento_slug_key";
DROP INDEX public."Associado_userId_key";
DROP INDEX public."Associado_cnpj_key";
...
ALTER TABLE ONLY public."QuemSomosSection" DROP CONSTRAINT "QuemSomosSection_pkey";
ALTER TABLE ONLY public."Presidente" DROP CONSTRAINT "Presidente_pkey";
ALTER TABLE ONLY public."Noticia" DROP CONSTRAINT "Noticia_pkey";
ALTER TABLE ONLY public."InscricaoEvento" DROP CONSTRAINT "InscricaoEvento_pkey";
ALTER TABLE ONLY public."HomeSlide" DROP CONSTRAINT "HomeSlide_pkey";
ALTER TABLE ONLY public."Evento" DROP CONSTRAINT "Evento_pkey";
ALTER TABLE ONLY public."Diretor" DROP CONSTRAINT "Diretor_pkey";
ALTER TABLE ONLY public."CertificadoSolicitacao" DROP CONSTRAINT "CertificadoSolicitacao_pkey";
ALTER TABLE ONLY public."Associado" DROP CONSTRAINT "Associado_pkey";
DROP TABLE public._prisma_migrations;
DROP TABLE public."User";
DROP TABLE public."Servico";
DROP TABLE public."QuemSomosSection";
DROP TABLE public."Presidente";
DROP TABLE public."Noticia";
DROP TABLE public."InscricaoEvento";
DROP TABLE public."HomeSlide";
DROP TABLE public."Evento";
DROP TABLE public."Diretor";
DROP TABLE public."CertificadoSolicitacao";
...
INSERT INTO public."Diretor" VALUES ('0576984d-9e16-4604-9b97-a72e4eaa8d17', 'FRANCISCO ROBERTO LIMA E SILVA', 'GRÁFICA CRATEÚS', 'I VICE-PRESIDENTE', 'http://localhost:3000/uploads/diretoria/e9ab8795-0c59-4a77-b712-23cfb5679689.jpg', NULL, 2, '2026-07-04 21:35:41.309', '2026-07-05 14:01:52.821');
INSERT INTO public."Diretor" VALUES ('49afb6ee-7f5d-4030-8bb3-d326c3cc92a6', 'ANTÔNIO WAGNER CLAUDINO SALES', 'RANCHEIRA W&S', 'II SECRETÁRIO', 'http://localhost:3000/uploads/diretoria/4ef5a8fd-6795-419f-bf52-4a9ecf9fe420.jpg', NULL, 3, '2026-07-04 21:38:43.887', '2026-07-05 14:01:57.767');
INSERT INTO public."Diretor" VALUES ('43526c1a-3e15-4fcf-93c1-0723cbc87f4a', 'ANTONIO OSVALDO PONTES DE MELO', 'TINA CONDIMENTOS', 'I SECRETÁRIO', 'http://localhost:3000/uploads/diretoria/b05d6daf-94e4-47e3-bf7b-d370f40626df.jpg', NULL, 4, '2026-07-04 21:38:15.398', '2026-07-05 14:02:03.724');
INSERT INTO public."Diretor" VALUES ('5453c786-3ce5-4ca8-900a-34042742d2b9', 'MARIA DO CARMO XIMENES DE PINHO', 'ACIC', 'PRESIDENTE', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aHVtYW4lMjBmYWNlfGVufDB8fDB8fHww', 'Empresária com vasta experiência no varejo e gestão corporativa, focada na inovação do comércio de Crateús.', 1, '2026-07-04 21:35:14.882', '2026-07-05 13:57:05.832');
...
INSERT INTO public."HomeSlide" VALUES ('b52b25a5-040c-4214-b632-81e0f9216480', 'Fortalecendo o comércio de Crateús', 'Há décadas unindo empresários e impulsionando a economia regional', 'http://localhost:3000/uploads/slides/7555ea21-a88f-410b-be1a-e280c588f5bc.jpg', NULL, 'PUBLISHED', 1, 'fe449d86-1afe-41a3-861d-2c5a1d2c572d', '2026-07-04 22:17:19.043', '2026-07-05 13:12:43.842');
INSERT INTO public."HomeSlide" VALUES ('c25a524d-877a-4d36-aa39-732bb1a11b58', 'Sua voz no desenvolvimento regional', 'Representação política e institucional para o empresário cearense', 'http://localhost:3000/uploads/slides/d781afdb-6271-46f8-8cef-7f5632d2d93b.jpg', NULL, 'PUBLISHED', 3, 'fe449d86-1afe-41a3-861d-2c5a1d2c572d', '2026-07-04 22:18:02.059', '2026-07-05 13:16:08.54');
INSERT INTO public."HomeSlide" VALUES ('578dabd7-1345-4ead-a1dd-be8aa16633a6', 'Conectando empresários de todos os setores', 'Comércio, indústria, agropecuária e serviços em um só lugar', 'http://localhost:3000/uploads/slides/3e665307-c29f-4bdc-962a-9aa90c2c2f2f.jpg', NULL, 'PUBLISHED', 2, 'fe449d86-1afe-41a3-861d-2c5a1d2c572d', '2026-07-04 22:17:46.545', '2026-07-05 13:17:51.699');
...
INSERT INTO public."Presidente" VALUES ('5a52e0d4-bafa-4f56-895d-42cbdbf9328b', 'Auton Aragão', 1921, 1925, 'http://localhost:3000/uploads/presidentes/43db60c8-5059-4fa4-8df0-bf3eaa72a984.jpeg', NULL, 1, '2026-07-05 02:40:56.8', '2026-07-05 02:40:56.8');
INSERT INTO public."Presidente" VALUES ('8dcdcc04-fa14-4abe-b531-b1d56ca22db3', 'Francisco Roberto Lima e Silva', 2017, 2023, 'http://localhost:3000/uploads/presidentes/a4d0ac6d-fe05-478a-8a57-a4862dd2222c.jpeg', 'Atual presidente, focado na reestruturação e modernização da entidade, além da defesa incansável dos direitos dos micro e pequenos empresários junto ao Governo Federal.', 26, '2026-07-04 22:26:48.785', '2026-07-05 02:28:54.442');
INSERT INTO public."Presidente" VALUES ('3c9926d6-607b-48e0-81fe-ac9112645861', 'Antônio Luiz Benevides Sales', 2015, 2016, 'http://localhost:3000/uploads/presidentes/7e86fcb7-0769-4d6a-9bdb-039e00b12927.jpeg', NULL, 25, '2026-07-04 22:31:44.362', '2026-07-05 02:29:09.339');
INSERT INTO public."Presidente" VALUES ('93202e54-dab9-49e1-b0b3-77e226e5351e', 'José de Melo Cavalcante', 1999, 2003, 'http://localhost:3000/uploads/presidentes/b9c69588-715e-4d98-bc0d-ee86f6ff285a.jpeg', NULL, 24, '2026-07-05 02:29:47.406', '2026-07-05 02:29:47.406');
INSERT INTO public."Presidente" VALUES ('0719e948-4b59-4805-97d6-8f776babfaf5', 'Fernando Antônio Aguiar Albuquerque', 1995, 1997, 'http://localhost:3000/uploads/presidentes/bbad030e-14e3-4093-9d85-0badc5bbf55f.jpeg', NULL, 23, '2026-07-05 02:30:01.465', '2026-07-05 02:30:10.554');
INSERT INTO public."Presidente" VALUES ('5c5a7764-7b78-4812-ba13-a8e04b518318', 'José Airton Melo Aguiar', 1991, 1993, 'http://localhost:3000/uploads/presidentes/a23f9848-543f-4f8f-a00c-9acb504afea7.jpeg', NULL, 22, '2026-07-05 02:30:30.979', '2026-07-05 02:30:30.979');
INSERT INTO public."Presidente" VALUES ('9eafa5e7-bf63-41dc-b417-89248b92de94', 'Antônio Soares Martins', 1984, 1991, 'http://localhost:3000/uploads/presidentes/7f12dfbe-005b-44b6-bbbe-49d52265882d.jpeg', NULL, 21, '2026-07-05 02:30:57.948', '2026-07-05 02:30:57.948');
INSERT INTO public."Presidente" VALUES ('6813e143-3145-4798-9144-2b162b1ec622', 'Edmundo Pinto Filho', 1982, 1984, 'http://localhost:3000/uploads/presidentes/190336ea-1a42-42fe-b05e-30f63c398fe0.jpeg', NULL, 20, '2026-07-05 02:31:19.152', '2026-07-05 02:31:19.152');
INSERT INTO public."Presidente" VALUES ('af05788b-b942-40d1-91d1-aec1f66b5813', 'Antonio Pimentel Rocha', 1980, 1982, 'http://localhost:3000/uploads/presidentes/fdc6f6aa-7c1b-4ac6-9de5-48d3023d1c98.jpeg', NULL, 19, '2026-07-05 02:32:45.406', '2026-07-05 02:32:45.406');
INSERT INTO public."Presidente" VALUES ('26ba2d7a-be02-4f88-94f4-1681d03bb39b', 'José Américo Moreira', 1978, 1980, 'http://localhost:3000/uploads/presidentes/58f307d0-b860-496e-846b-11b87664699c.jpeg', NULL, 18, '2026-07-05 02:33:06.134', '2026-07-05 02:33:06.134');
INSERT INTO public."Presidente" VALUES ('f5f39a91-dc76-4a5f-af21-cbac94af719b', 'Raimundo Bezerra de Melo', 1976, 1978, 'http://localhost:3000/uploads/presidentes/dd6c15b9-778c-4543-802c-9800a3b62b02.jpeg', NULL, 17, '2026-07-05 02:33:41.152', '2026-07-05 02:33:41.152');
INSERT INTO public."Presidente" VALUES ('2b594e6f-d8b7-402d-b8cb-e42c6a2f36ae', 'Raimundo Soares Resende', 1974, 1976, 'http://localhost:3000/uploads/presidentes/cd56042b-e4c0-4d16-9133-e9e30123b7cf.jpeg', NULL, 16, '2026-07-05 02:34:23.402', '2026-07-05 02:34:23.402');
INSERT INTO public."Presidente" VALUES ('2ea9b675-a5d7-499e-825c-5662d7d620de', 'Boanerges Cisne Sales', 1971, 1974, 'http://localhost:3000/uploads/presidentes/5513a420-650d-4d76-9c70-2466990dc235.jpeg', NULL, 15, '2026-07-05 02:34:57.106', '2026-07-05 02:34:57.106');
INSERT INTO public."Presidente" VALUES ('1aa15cad-2bbe-4e1d-8563-63d49e03d846', 'João José de Castro', 1968, 1971, 'http://localhost:3000/uploads/presidentes/f6583c58-d50a-41f3-98d6-b87284e5cbf6.jpeg', NULL, 14, '2026-07-05 02:35:14.968', '2026-07-05 02:35:14.968');
INSERT INTO public."Presidente" VALUES ('00929f4d-2cc3-4563-8278-11ce966dfd35', 'Francisco de Assis Machado', 1964, 1968, 'http://localhost:3000/uploads/presidentes/d93b368e-bf42-4aa7-88f2-6fa6f3d8f956.jpeg', NULL, 13, '2026-07-05 02:36:24.276', '2026-07-05 02:36:24.276');
INSERT INTO public."Presidente" VALUES ('1a13f500-bf11-4318-8580-991b3ba67e4e', 'Antônio de Melo Rosa', 1961, 1964, 'http://localhost:3000/uploads/presidentes/c7a7c113-0414-4979-b918-681d7c28602b.jpeg', NULL, 12, '2026-07-05 02:36:41.675', '2026-07-05 02:36:41.675');
INSERT INTO public."Presidente" VALUES ('6205b722-3052-450a-b4f6-51648b138682', 'Armando Marques Mourão', 1958, 1961, 'http://localhost:3000/uploads/presidentes/72d62d0c-a929-4fd4-b09a-0726a0107b28.jpeg', NULL, 11, '2026-07-05 02:37:21.566', '2026-07-05 02:37:21.566');
INSERT INTO public."Presidente" VALUES ('a92e2c9d-0d31-412f-a560-44b2a99e1c32', 'Pedro de Miranda Melo', 1954, 1958, 'http://localhost:3000/uploads/presidentes/b3826258-469d-4659-a852-bb5e0f7875f2.jpeg', NULL, 10, '2026-07-05 02:37:44.971', '2026-07-05 02:37:44.971');
INSERT INTO public."Presidente" VALUES ('2ff8c42f-371c-4aff-bc0f-1fde0719c2e8', 'Bento Coutinho de Macedo', 1951, 1954, 'http://localhost:3000/uploads/presidentes/4d260188-e51a-48a9-9ca6-50baaa31fd5b.jpeg', NULL, 9, '2026-07-05 02:38:13.182', '2026-07-05 02:38:13.182');
INSERT INTO public."Presidente" VALUES ('4e8029d1-57f8-414d-b2db-1a50328b4b41', 'Julio Evaristo de Paiva', 1947, 1951, 'http://localhost:3000/uploads/presidentes/63514f0d-e9ca-47b8-8730-22c99c10d806.jpeg', NULL, 8, '2026-07-05 02:38:32.151', '2026-07-05 02:38:32.151');
INSERT INTO public."Presidente" VALUES ('73df3705-8351-44b9-a27a-83bafacca9e3', 'Francisco Melo Lima', 1943, 1947, 'http://localhost:3000/uploads/presidentes/8a906a0e-e905-42ab-a362-15554250686c.jpeg', NULL, 7, '2026-07-05 02:38:51.777', '2026-07-05 02:38:51.777');
INSERT INTO public."Presidente" VALUES ('66c3d9a7-ff22-414d-971e-4e594beaeb43', 'Manoel Evaristo de Paiva', 1939, 1943, 'http://localhost:3000/uploads/presidentes/e2cedd8e-52ac-44cc-b607-aebc54befcff.jpeg', NULL, 6, '2026-07-05 02:39:10.972', '2026-07-05 02:39:10.972');
INSERT INTO public."Presidente" VALUES ('fc440316-4f8c-4975-89e7-c11a0353ee2f', 'Pedro Machado da Ponte', 1935, 1939, 'http://localhost:3000/uploads/presidentes/3cec27bd-4091-4f2b-adfd-84544fca365d.jpeg', NULL, 5, '2026-07-05 02:39:56.165', '2026-07-05 02:39:56.165');
INSERT INTO public."Presidente" VALUES ('0451075a-ee86-451e-b748-0960e3126131', 'Abel Alcanfor Soares', 1931, 1935, 'http://localhost:3000/uploads/presidentes/5b220f98-fc99-4c9a-8e76-bff65947dcff.jpeg', NULL, 4, '2026-07-05 02:40:10.702', '2026-07-05 02:40:10.702');
INSERT INTO public."Presidente" VALUES ('97577a77-83f4-4f88-977b-5a5ccadc52cc', 'Firmino Rocha Aguiar', 1929, 1931, 'http://localhost:3000/uploads/presidentes/eb2d6d1e-6e63-4504-ae10-370183242b27.jpeg', NULL, 3, '2026-07-05 02:40:27.632', '2026-07-05 02:40:27.632');
INSERT INTO public."Presidente" VALUES ('38f93392-0855-4d27-a110-70994bf0d979', 'Francisco Mariano Cavalcante', 1925, 1929, 'http://localhost:3000/uploads/presidentes/17b7ed19-8a26-4987-a443-296d52e42f0e.jpeg', NULL, 2, '2026-07-05 02:40:41.261', '2026-07-05 02:40:41.261');
...
INSERT INTO public."User" VALUES ('fe449d86-1afe-41a3-861d-2c5a1d2c572d', 'Administrador ACIC', 'admin@acic.local', '$2b$10$n9NWI9iehqdhbqa9d1.rpOp7V38HT9wkuUPylv71YE4BOPLyAZWYW', 'ADMIN', true, '2026-07-04 13:41:14.321', '2026-07-04 13:41:14.321');
...
INSERT INTO public._prisma_migrations VALUES ('4044045e-6466-4fb8-bd21-980276ff17ed', 'fe20df575463e75531652f922a35925ec426f5e177b55ebe586108c239208c46', '2026-07-04 13:40:36.052149+00', '20260609152000_init', NULL, NULL, '2026-07-04 13:40:35.865145+00', 1);
INSERT INTO public._prisma_migrations VALUES ('ba697132-5412-4f71-a04e-a4e2f27fa7e1', '5d2a4b83c6b6f4656f84189281bad7ce8cb0d614117119b5ef2084c7ba40994d', '2026-07-04 13:40:36.06676+00', '20260611170426_add_destaque_flag', NULL, NULL, '2026-07-04 13:40:36.05681+00', 1);
INSERT INTO public._prisma_migrations VALUES ('91800739-632e-4712-99bd-a3aa8b40770e', 'cdfb9d07c936469e1892ea772fa6170332fc7829e01d9dc380277465ee4a4e51', '2026-07-04 13:40:36.091608+00', '20260618002945_add_diretor', NULL, NULL, '2026-07-04 13:40:36.071515+00', 1);
INSERT INTO public._prisma_migrations VALUES ('867f2c6f-7edd-49e1-8e61-609f06cf4a2c', 'e916f28cd574eae2bda4c66f5c9f1abd70aeb7171e14541b3bdbd2d4e30a2949', '2026-07-05 14:22:23.62882+00', '20260705142223_add_cover_image_options', NULL, NULL, '2026-07-05 14:22:23.614276+00', 1);
...
\unrestrict EJXdc9UxcPaaJiFk0kgaZr49S54WABx2Rt2Kx9fqu9D1tcTmp1zUcKWoBCgykpf
